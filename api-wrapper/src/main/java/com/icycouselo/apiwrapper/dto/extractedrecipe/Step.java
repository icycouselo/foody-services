...
public class Step {
    ...
    public boolean equals(Object other) {
        ...
        Step rhs = ((Step) other);
        return (((((((this.number == rhs.number)||((this.number!= null)&&this.number.equals(rhs.number)))&&((this.length == rhs.length)||((this.length!= null)&&this.length.equals(rhs.length))))&&((this.ingredients == rhs.ingredients)||((this.ingredients!= null)&&this.ingredients.equals(rhs.ingredients))))&&((this.equipment == rhs.equipment)||((this.equipment!= null)&&this.equipment.equals(rhs.equipment))))&&((this.step == rhs.step)||((this.step!= null)&&this.step.equals(rhs.step))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
