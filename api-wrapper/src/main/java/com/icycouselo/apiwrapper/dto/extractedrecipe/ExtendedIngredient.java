...
public class ExtendedIngredient {
    ...
    public String toString() {
        ...
        sb.append(ExtendedIngredient.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((this.image == rhs.image)||((this.image!= null)&&this.image.equals(rhs.image)))&&((this.amount == rhs.amount)||((this.amount!= null)&&this.amount.equals(rhs.amount))))&&((this.nameClean == rhs.nameClean)||((this.nameClean!= null)&&this.nameClean.equals(rhs.nameClean))))&&((this.original == rhs.original)||((this.original!= null)&&this.original.equals(rhs.original))))&&((this.aisle == rhs.aisle)||((this.aisle!= null)&&this.aisle.equals(rhs.aisle))))&&((this.consistency == rhs.consistency)||((this.consistency!= null)&&this.consistency.equals(rhs.consistency))))&&((this.originalName == rhs.originalName)||((this.originalName!= null)&&this.originalName.equals(rhs.originalName))))&&((this.unit == rhs.unit)||((this.unit!= null)&&this.unit.equals(rhs.unit))))&&((this.measures == rhs.measures)||((this.measures!= null)&&this.measures.equals(rhs.measures))))&&((this.meta == rhs.meta)||((this.meta!= null)&&this.meta.equals(rhs.meta))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
