...
public class ExractedRecipeDTO {
    ...
    public ExractedRecipeDTO withAnalyzedInstructions(List<AnalyzedInstruction> analyzedInstructions) {
        this.analyzedInstructions = analyzedInstructions;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ExractedRecipeDTO.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.analyzedInstructions == null)? 0 :this.analyzedInstructions.hashCode()));
        ...
        result = ((result* 31)+((this.preparationMinutes == null)? 0 :this.preparationMinutes.hashCode()));
        ...
        result = ((result* 31)+((this.extendedIngredients == null)? 0 :this.extendedIngredients.hashCode()));
        ...
        result = ((result* 31)+((this.weightWatcherSmartPoints == null)? 0 :this.weightWatcherSmartPoints.hashCode()));
        result = ((result* 31)+((this.occasions == null)? 0 :this.occasions.hashCode()));
        result = ((result* 31)+((this.pricePerServing == null)? 0 :this.pricePerServing.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((((((((((((((((((((((this.instructions == rhs.instructions)||((this.instructions!= null)&&this.instructions.equals(rhs.instructions)))&&((this.sustainable == rhs.sustainable)||((this.sustainable!= null)&&this.sustainable.equals(rhs.sustainable))))&&((this.analyzedInstructions == rhs.analyzedInstructions)||((this.analyzedInstructions!= null)&&this.analyzedInstructions.equals(rhs.analyzedInstructions))))&&((this.glutenFree == rhs.glutenFree)||((this.glutenFree!= null)&&this.glutenFree.equals(rhs.glutenFree))))&&((this.veryPopular == rhs.veryPopular)||((this.veryPopular!= null)&&this.veryPopular.equals(rhs.veryPopular))))&&((this.healthScore == rhs.healthScore)||((this.healthScore!= null)&&this.healthScore.equals(rhs.healthScore))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.diets == rhs.diets)||((this.diets!= null)&&this.diets.equals(rhs.diets))))&&((this.aggregateLikes == rhs.aggregateLikes)||((this.aggregateLikes!= null)&&this.aggregateLikes.equals(rhs.aggregateLikes))))&&((this.readyInMinutes == rhs.readyInMinutes)||((this.readyInMinutes!= null)&&this.readyInMinutes.equals(rhs.readyInMinutes))))&&((this.sourceUrl == rhs.sourceUrl)||((this.sourceUrl!= null)&&this.sourceUrl.equals(rhs.sourceUrl))))&&((this.creditsText == rhs.creditsText)||((this.creditsText!= null)&&this.creditsText.equals(rhs.creditsText))))&&((this.dairyFree == rhs.dairyFree)||((this.dairyFree!= null)&&this.dairyFree.equals(rhs.dairyFree))))&&((this.servings == rhs.servings)||((this.servings!= null)&&this.servings.equals(rhs.servings))))&&((this.vegetarian == rhs.vegetarian)||((this.vegetarian!= null)&&this.vegetarian.equals(rhs.vegetarian))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.preparationMinutes == rhs.preparationMinutes)||((this.preparationMinutes!= null)&&this.preparationMinutes.equals(rhs.preparationMinutes))))&&((this.imageType == rhs.imageType)||((this.imageType!= null)&&this.imageType.equals(rhs.imageType))))&&((this.summary == rhs.summary)||((this.summary!= null)&&this.summary.equals(rhs.summary))))&&((this.cookingMinutes == rhs.cookingMinutes)||((this.cookingMinutes!= null)&&this.cookingMinutes.equals(rhs.cookingMinutes))))&&((this.image == rhs.image)||((this.image!= null)&&this.image.equals(rhs.image))))&&((this.openLicense == rhs.openLicense)||((this.openLicense!= null)&&this.openLicense.equals(rhs.openLicense))))&&((this.veryHealthy == rhs.veryHealthy)||((this.veryHealthy!= null)&&this.veryHealthy.equals(rhs.veryHealthy))))&&((this.vegan == rhs.vegan)||((this.vegan!= null)&&this.vegan.equals(rhs.vegan))))&&((this.cheap == rhs.cheap)||((this.cheap!= null)&&this.cheap.equals(rhs.cheap))))&&((this.extendedIngredients == rhs.extendedIngredients)||((this.extendedIngredients!= null)&&this.extendedIngredients.equals(rhs.extendedIngredients))))&&((this.dishTypes == rhs.dishTypes)||((this.dishTypes!= null)&&this.dishTypes.equals(rhs.dishTypes))))&&((this.gaps == rhs.gaps)||((this.gaps!= null)&&this.gaps.equals(rhs.gaps))))&&((this.cuisines == rhs.cuisines)||((this.cuisines!= null)&&this.cuisines.equals(rhs.cuisines))))&&((this.lowFodmap == rhs.lowFodmap)||((this.lowFodmap!= null)&&this.lowFodmap.equals(rhs.lowFodmap))))&&((this.weightWatcherSmartPoints == rhs.weightWatcherSmartPoints)||((this.weightWatcherSmartPoints!= null)&&this.weightWatcherSmartPoints.equals(rhs.weightWatcherSmartPoints))))&&((this.occasions == rhs.occasions)||((this.occasions!= null)&&this.occasions.equals(rhs.occasions))))&&((this.pricePerServing == rhs.pricePerServing)||((this.pricePerServing!= null)&&this.pricePerServing.equals(rhs.pricePerServing))))&&((this.sourceName == rhs.sourceName)||((this.sourceName!= null)&&this.sourceName.equals(rhs.sourceName))))&&((this.originalId == rhs.originalId)||((this.originalId!= null)&&this.originalId.equals(rhs.originalId))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
