...
public class Measures {
    ...
    public String toString() {
        ...
        sb.append(Measures.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("us");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties)))&&((this.metric == rhs.metric)||((this.metric!= null)&&this.metric.equals(rhs.metric))))&&((this.us == rhs.us)||((this.us!= null)&&this.us.equals(rhs.us))));
    }
